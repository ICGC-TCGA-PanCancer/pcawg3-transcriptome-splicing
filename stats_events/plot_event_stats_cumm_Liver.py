...
BASEDIR_GTEX   = os.path.join(BASEDIR_AS, 'alternative_splicing_gtex_Liver_small')
BASEDIR_ICGC_T = os.path.join(BASEDIR_AS, 'alternative_splicing_LIRI-JP_small_tumor') 
BASEDIR_ICGC_N = os.path.join(BASEDIR_AS, 'alternative_splicing_LIRI-JP_small_normal')
